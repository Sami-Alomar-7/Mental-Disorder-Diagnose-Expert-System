...
class MyKnowledgeEngine(KnowledgeEngine):
    ...
    def initialize(self):
        ...
        yield Characteristic(id=78, label='Avoidance of situations that trigger obsessions and compulsions',
                             significance=0.0)
        ...
        yield Characteristic(id=87,
                             label='Avoidance or attraction to food based on appearance, smell, taste, and temperature',
                             significance=0.0)
        ...
        yield Characteristic(id=98, label='Engaging in fire-setting or theft to relieve internal feelings',
                             significance=0.0)
        ...
        yield Characteristic(id=122, label='Envy of others and belief that others are envious of them',
                             significance=0.0)
        ...
        yield Question(
            ...
            characteristics=[
                Characteristic(label='Obsessions', significance=0.95),
                Characteristic(label='Compulsions', significance=0.84),
                Characteristic(label='Avoidance of situations that trigger obsessions and compulsions',
                               significance=0.84)
            ],
            certaintyFactor=0.0,
            isAsked=False
        ...
        yield Question(
            ...
            characteristics=[
                Characteristic(label='Engaging in fire-setting or theft to relieve internal feelings',
                               significance=1.0),
    ...
    def update_characteristics(self, characteristics, answer_cf):
        ...
        characteristics_to_update = [char for char in self.facts.values() if
                                     isinstance(char, Characteristic) and char['label'] in labels_to_update]
    ...
    @Rule(
        ...
        AS.question_instance << Question(id=MATCH.id, content=MATCH.question_content, disorder=MATCH.disorder_name,
                                         characteristics=MATCH.characteristics, isAsked=MATCH.isAsked),
        Diagnosed(isDiagnosed=MATCH.isDiagnosed),
        TEST(lambda isAsked, isDiagnosed: not isAsked and not isDiagnosed)
    )
    def ask_two_questions_from_each_disorder(self, disorder_instance, disorder_name, num_asked, question_instance,
                                             question_content, characteristics):
    ...
    def little_sus_about_Dissociative_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                                question_content, characteristics):
        self.did_sus = True
    ...
    def real_sus_about_Dissociative_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                              question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Schizophrenia(self, disorder_instance, disorder_name, num_asked, question_instance,
                                       question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_Schizophrenia(self, disorder_instance, disorder_name, num_asked, question_instance,
                                     question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Bipolar_Disorder(self, disorder_instance, disorder_name, num_asked, question_instance,
                                          question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_Bipolar_Disorder(self, disorder_instance, disorder_name, num_asked, question_instance,
                                        question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Depressive_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                              question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_Depressive_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                            question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_ADHD(self, disorder_instance, disorder_name, num_asked, question_instance, question_content,
                              characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_ADHD(self, disorder_instance, disorder_name, num_asked, question_instance, question_content,
                            characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Autism(self, disorder_instance, disorder_name, num_asked, question_instance, question_content,
                                characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_Autism(self, disorder_instance, disorder_name, num_asked, question_instance, question_content,
                              characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Anxiety_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                           question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_Anxiety_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                         question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    @Rule(
        ...
        Characteristic(label=L('Avoidance of situations that trigger obsessions and compulsions'),
                       significance=GE(0.4)),
    ...
    def little_sus_about_OCD(self, disorder_instance, disorder_name, num_asked, question_instance, question_content,
                             characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_OCD(self, disorder_instance, disorder_name, num_asked, question_instance, question_content,
                           characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Somatic_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                           question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_Somatic_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                         question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Feeding_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                           question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    @Rule(
        ...
        Characteristic(label=L('Reliance on dietary supplements'), significance=GE(0.45)),
        Characteristic(label=L('Life problems'), significance=GE(0.4)),
        Characteristic(label=L('Avoidance or attraction to food based on appearance, smell, taste, and temperature'),
                       significance=GE(0.5)),
        AS.disorder_instance << Disorder(label=MATCH.disorder_name, number_of_asked_question=MATCH.num_asked),
    ...
    def real_sus_about_Feeding_Disorders(self, disorder_instance, disorder_name, num_asked, question_instance,
                                         question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    @Rule(
        ...
        Characteristic(label=L('Life problems'), significance=GE(0.4)),
        AS.disorder_instance << Disorder(label=MATCH.disorder_name, number_of_asked_question=MATCH.num_asked),
        TEST(lambda num_asked,
                    disorder_name: num_asked < 5 and disorder_name == 'Disruptive, Impulse-Control, and Conduct Disorders'),
        AS.question_instance << Question(id=MATCH.id, content=MATCH.question_content, disorder=MATCH.disorder_name,
                                         characteristics=MATCH.characteristics, isAsked=MATCH.isAsked),
        Diagnosed(isDiagnosed=MATCH.isDiagnosed),
        TEST(lambda isAsked, isDiagnosed: not isAsked and not isDiagnosed)
    )
    def little_sus_about_Disruptive_Impulse_Control_and_Conduct_Disorders(self, disorder_instance, disorder_name,
                                                                          num_asked, question_instance,
                                                                          question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_Disruptive_Impulse_Control_and_Conduct_Disorders(self, disorder_instance, disorder_name,
                                                                        num_asked, question_instance, question_content,
                                                                        characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    @Rule(
        ...
        AS.disorder_instance << Disorder(label=MATCH.disorder_name, number_of_asked_question=MATCH.num_asked),
        TEST(lambda num_asked,
                    disorder_name: num_asked < 5 and disorder_name == 'ASPD (Antisocial Personality Disorder)'),
        AS.question_instance << Question(id=MATCH.id, content=MATCH.question_content, disorder=MATCH.disorder_name,
                                         characteristics=MATCH.characteristics, isAsked=MATCH.isAsked),
        Diagnosed(isDiagnosed=MATCH.isDiagnosed),
        TEST(lambda isAsked, isDiagnosed: not isAsked and not isDiagnosed)
    )
    def little_sus_about_ASPD(self, disorder_instance, disorder_name, num_asked, question_instance, question_content,
                              characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_ASPD(self, disorder_instance, disorder_name, num_asked, question_instance, question_content,
                            characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Borderline_Personality_Disorder(self, disorder_instance, disorder_name, num_asked,
                                                         question_instance, question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
        self.ask(question_content)
    ...
    def real_sus_about_Borderline_Personality_Disorder(self, disorder_instance, disorder_name, num_asked,
                                                       question_instance, question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
    ...
    def little_sus_about_Narcissistic_Personality_Disorder(self, disorder_instance, disorder_name, num_asked,
                                                           question_instance, question_content, characteristics):
        self.did_sus = True
        if disorder_name not in self.sus_list:
            self.sus_list.append(disorder_name)
    ...
    def real_sus_about_Narcissistic_Personality_Disorder(self, disorder_instance, disorder_name, num_asked,
                                                         question_instance, question_content, characteristics):
        self.did_prob = True
        self.ask(question_content)
        self.chars = characteristics
